/**
 * Highlights the core product capabilities featured on the marketing site.
 */
...
/**
 * Defines the capability cards rendered in the feature grid.
 */
const items = [
  {
    icon: Wifi,
...
/**
 * Renders the marketing feature grid.
 *
 * @returns The feature overview section.
 */

/**
 * Renders the primary hero section for the marketing homepage.
 */
...
/**
 * Introduces the product positioning and top-level calls to action.
 *
 * @returns The homepage hero section.
 */
export const Hero = () => {
  return (
    <section className="relative overflow-hidden py-28 lg:py-32 lg:pt-44">
      ...
      <div className="container relative flex flex-col items-center text-center">
        ...
        <h1 className="max-w-4xl text-4xl tracking-tight md:text-5xl lg:text-6xl xl:text-7xl">
          <span className="gradient-heading block">

/**
 * Displays the investor logo and attribution strip for the marketing site.
 */
import Image from "next/image";

/**
 * Defines the investor cards rendered in the grid.
 */
const investors = [
  {
    name: "Dennis Bouvard",
...
/**
 * Renders the investor showcase grid.
 *
 * @returns The investor section.
 */

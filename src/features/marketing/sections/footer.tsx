/**
 * Renders the footer used across the marketing experience.
 */
import { ArrowUpRight } from "lucide-react";
import Link from "next/link";

/**
 * Displays the marketing footer navigation, branding, and wordmark.
 *
 * @returns The site footer.
 */
export function Footer() {
  /**
   * Defines the primary product links shown in the footer.
   */
  const product = [
  ...
  /**
   * Defines the company-related links shown in the footer.
   */
  const company = [
  ...
  /**
   * Defines the legal links shown in the footer.
   */
  const legal = [

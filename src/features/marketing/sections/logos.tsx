/**
 * Renders the partner logo rows used in the marketing social proof section.
 */
...
/**
 * Describes a company logo entry rendered in the logo rows.
 */
type Company = {
  name: string;
  logo: string;
...
/**
 * Renders the social-proof logo section with separate desktop and mobile
 * presentations.
 *
 * @returns The logo showcase section.
 */
export const Logos = () => {
  /**
   * Defines the first desktop row and matching marquee entries.
   */
  ...
  /**
   * Defines the second desktop row and matching marquee entries.
   */
...
/**
 * Defines the props accepted by a reusable logo row.
 */
type LogoRowProps = {
  companies: Company[];
...
/**
 * Renders a logo row as a static grid on desktop and marquee on mobile.
 *
 * @param props - Companies to display and layout direction hints.
 * @returns The responsive logo row.
 */

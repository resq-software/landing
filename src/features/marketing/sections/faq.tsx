/**
 * Defines the frequently asked questions displayed on marketing pages.
 */
...
/**
 * Stores the FAQ content rendered in the accordion list.
 */
const questions = [
  {
...
/**
 * Describes the configurable heading and layout variants for the FAQ section.
 */
type FAQProps = {
  headerTag?: "h1" | "h2";
  className?: string;
...
/**
 * Renders the marketing FAQ section with an optional page-level heading.
 *
 * @param props - Heading semantics and section class overrides.
 * @returns The FAQ accordion section.
 */
export const FAQ = ({ headerTag = "h2", className, className2 }: FAQProps) => {
  return (

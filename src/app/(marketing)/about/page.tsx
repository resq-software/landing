/**
 * Defines the About route for the marketing site.
 */
import type { Metadata } from "next";
import Link from "next/link";
import { Button } from "@/components/ui/button";
import { Background } from "@/features/marketing/components/background";
import { DashedLine } from "@/features/marketing/components/dashed-line";

/**
 * Provides page-specific metadata for the About route.
 */
...
/**
 * Enumerates the narrative content blocks rendered on the About page.
 */
const sections = [
  {
...
/**
 * Renders the About page and its product-story content.
 *
 * @returns The About route content.
 */
